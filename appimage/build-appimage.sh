...
NO_STRIP=1 linuxdeploy-x86_64.AppImage --appdir AppDir -e mpv -i "AppDir/usr/share/icons/hicolor/scalable/apps/mpv.svg" -d "AppDir/usr/share/applications/mpv.desktop" -l /usr/local/lib/libsobacas.so.0 -l /usr/local/lib/libyakisoba.so.0 -l /usr/lib/libpcsclite.so.1 -l $(realpath /usr/lib/libplacebo.so) -l /usr/lib/libass.so.9 -l /usr/lib/libvpx.so.9 -l /usr/lib/libacl.so.1 --output appimage
