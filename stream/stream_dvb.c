...
const struct m_sub_options stream_dvb_conf = {
    .opts = (const m_option_t[]) {
        ...
        {"frontend", OPT_INT(cfg_fe), M_RANGE(0, MAX_FRONTENDS-1)},
        {"demux", OPT_INT(cfg_dmx), M_RANGE(0, MAX_FRONTENDS-1)},
        {"dvr", OPT_INT(cfg_dvr), M_RANGE(0, MAX_FRONTENDS-1)},
        ...
        {"scan-all-devs", OPT_FLAG(cfg_scan_all_devs)},
        {0}
    },
