...
```
cd <somewhere>
git clone [--depth 1] -b isdb-6.1 https://github.com/0p1pp1/ffmpeg
cd ffmpeg
mkdir build; cd build
...
```
cd <somewhere>
git clone [--depth 1] -b isdb-0.36 https://github.com/0p1pp1/mpv
cd mpv
